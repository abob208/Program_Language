...
void Parser::Set_Variable_value( Value value, string ID ) {
  ...
  for ( int i = 0 ; i < mRegionvariable.size() ; i++ ) {
    if ( ID == mRegionvariable[i].name ) {
      mRegionvariable[i].value = value ;
      // cout << "-------------" << ID ;
      return ;
    } // if
  } // for
...
Value Parser::IDvalue( string ID ) {
  ...
  for ( int i = 0 ; i < mRegionvariable.size() ; i++ ) {
    if ( ID == mRegionvariable[i].name ) {
      return mRegionvariable[i].value ;
    } // if
  } // for
...
void Parser::CAL_Rest_of_declarators() {
  ...
  mRegionvariable.push_back( variable ) ;
